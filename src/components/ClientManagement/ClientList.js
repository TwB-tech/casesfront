...
import { UserOutlined, PlusOutlined, SearchOutlined, CheckCircleOutlined, StopOutlined } from '@ant-design/icons';
...
function ClientList() {
  ...
  const [viewMode, setViewMode] = useState(sessionStorage.getItem('clientViewMode') || 'table');
  ...
  useEffect(() => {
    sessionStorage.setItem('clientViewMode', viewMode);
  }, [viewMode]);
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: 'email',
      key: 'email',
      render: (email) => <span style={{ color: isFuturistic ? '#e2e8f0' : '#475569' }}>{email}</span>,
    },
    {
      title: 'Phone',
    ...
    <div style={{ 
      ...
      <Row gutter={[16, 16]} style={{ marginBottom: '24px' }}>
        <Col xs={12} sm={8}>
          ...
          >
            <Statistic 
              title={<span style={{ color: isFuturistic ? '#94a3b8' : '#64748b', fontSize: '12px' }}>Total Clients</span>} 
              value={stats.total} 
              valueStyle={{ color: isFuturistic ? '#f8fafc' : '#1e293b', fontWeight: 700, fontSize: '24px' }}
              prefix={<UserOutlined style={{ color: isFuturistic ? '#6366f1' : '#3b82f6', marginRight: '8px' }} />}
            />
          </Card>
        </Col>
        <Col xs={12} sm={8}>
          ...
          >
            <Statistic 
              title={<span style={{ color: isFuturistic ? '#94a3b8' : '#64748b', fontSize: '12px' }}>Active</span>} 
              value={stats.active} 
        ...
        <Col xs={12} sm={8}>
          ...
          >
            <Statistic 
              title={<span style={{ color: isFuturistic ? '#94a3b8' : '#64748b', fontSize: '12px' }}>Inactive</span>} 
