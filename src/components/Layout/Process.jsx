...
import { Scale, FileText, Users, BarChart3, Clock, Shield, Zap } from 'lucide-react';
...
const Process = () => {
  ...
  const features = [
    {
      ...
      description:
        'Track case progress, manage client relationships, and organize all case files in one secure location.',
      color: 'primary',
    },
    {
      icon: Clock,
      ...
      description:
        'Never miss a deadline with automated reminders, task assignment, and progress monitoring.',
      color: 'accent',
    },
    {
      icon: BarChart3,
      ...
      description:
        'Generate comprehensive reports on case status, billing, and firm performance with one click.',
      color: 'success',
    },
    {
      icon: FileText,
      ...
      description:
        'Upload, organize, and share legal documents securely with version control and access tracking.',
      color: 'warning',
    },
    {
      icon: Users,
      ...
      description:
        'Work seamlessly with your team, assign tasks, and track progress across all matters.',
      color: 'primary',
    },
    {
      icon: Shield,
      ...
      description:
        'Bank-grade encryption and compliance features to protect your sensitive client data.',
      color: 'success',
    },
  ];
  ...
  return (
    <div
      className={`mt-12 lg:mt-0 relative overflow-hidden ${
        isFuturistic
    ...
    >
      ...
      <div className="hidden lg:block absolute inset-0 overflow-hidden pointer-events-none opacity-30">
        ...
        <img
          src={V1}
          alt="decor"
          className="absolute -right-5 top-[60vh] scale-75 z-10"
          draggable={false}
        />
        <img
          src={V3}
          alt="decor"
          className="absolute right-0 top-[30vh] w-40 z-10"
          draggable={false}
        />
        <img
          src={V4}
          alt="decor"
          className="absolute top-[90vh] left-10 w-36 z-10"
          draggable={false}
        />
        <img
          src={V5}
          alt="decor"
          className="absolute top-[85vh] lg:top-[75vh] lg:right-[30vw] w-28 z-10"
          draggable={false}
        />
      </div>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        />
        <div
          className={`absolute bottom-20 right-1/4 w-72 h-72 rounded-full blur-3xl opacity-15 ${
      ...
      <div className="relative z-20 py-12 px-6 lg:py-24 text-center">
        <div
          className={`text-sm lg:text-base font-semibold tracking-wider mb-3 ${
        ...
        <p
          className={`leading-normal sm:leading-relaxed mb-8 max-w-2xl mx-auto text-base md:text-lg ${
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8 max-w-6xl mx-auto">
            {features.map((feature, index) => (
              ...
              >
                <div
                  className={`w-14 h-14 rounded-xl flex items-center justify-center mb-4 ${
                    feature.color === 'primary'
                      ? isFuturistic
                        ? 'bg-aurora-primary/20'
                        : 'bg-white/20'
                      : feature.color === 'accent'
                        ? isFuturistic
                          ? 'bg-aurora-secondary/20'
                          : 'bg-accent-400/20'
                ...
                <p className={`text-sm ${isFuturistic ? 'text-aurora-muted' : 'text-white/80'}`}>
                  {feature.description}
                </p>
              </div>
            ))}
