...
const Start = () => {
  ...
  return (
    <div
      className={`min-h-[90vh] w-full mb-0 relative overflow-hidden ${
        isFuturistic
    ...
    >
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-40 py-8 lg:py-[8rem] px-4 md:px-8 lg:px-16">
        ...
        >
          <div
            className={`mb-4 text-sm md:text-base lg:text-lg font-semibold tracking-wider ${
          ...
          <h1
            className={`text-[1.5rem] md:text-[2.5rem] lg:text-[3rem] font-bold mb-4 ${
          ...
          <p
            className={`mb-6 lg:mb-8 text-xs md:text-sm lg:text-lg max-w-xl ${
          ...
          >
            ...
            on-demand. No recruitment fees. No long-term commitments. Just qualified legal support
            when you need it, integrated seamlessly with your existing case management workflow.
          </p>
        ...
        >
          ...
          <div
            className={`relative ${isFuturistic ? 'drop-shadow-2xl shadow-aurora-primary/20' : ''}`}
          >
            <img
              src={computer}
