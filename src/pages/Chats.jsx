...
import { UserOutlined, SendOutlined, SmileOutlined, SearchOutlined } from '@ant-design/icons';
import useAuth from '../hooks/useAuth';
import axiosInstance from '../axiosConfig';
                                ...
                                >
                                    <div style={{
                                        ...
                                        background: msg.sender_id === user.id 
                                            ? (isFuturistic ? '#6366f1' : '#3b82f6')
                                            : (isFuturistic ? '#252532' : '#ffffff'),
                                        color: msg.sender_id === user.id ? '#ffffff' : (isFuturistic ? '#f8fafc' : '#1e293b'),
