            ...
            <ul className="space-y-4">
                ...
                {user.role === 'advocate' && clients.length > 0 && (
                    <>
                        ...
                        {clients.map(client => (
                            <li key={client.id} className="border dark:border-zinc-700 p-4 rounded-lg hover:bg-blue-50 dark:hover:bg-zinc-700 transition-colors">
                                <div className="flex justify-between items-center">
                                    <span className="font-medium text-gray-900 dark:text-white">{client.username}</span>
                                    <button 
                ...
                {advocates.length > 0 && (
                    <>
                        ...
                        {advocates.map(advocate => (
                            <li key={advocate.id} className="border dark:border-zinc-700 p-4 rounded-lg hover:bg-blue-50 dark:hover:bg-zinc-700 transition-colors">
                                <div className="flex justify-between items-center">
                                    <span className="font-medium text-gray-900 dark:text-white">{advocate.username}</span>
                                    <button 
