import{Y as e}from"./render-CSz5UrC5.js";import{m as t}from"./tooltip-1qkmptMw.js";var n=new e(`antFadeIn`,{"0%":{opacity:0},"100%":{opacity:1}}),r=new e(`antFadeOut`,{"0%":{opacity:1},"100%":{opacity:0}}),i=function(e){let i=arguments.length>1&&arguments[1]!==void 0?arguments[1]:!1,{antCls:a}=e,o=`${a}-fade`,s=i?`&`:``;return[t(o,n,r,e.motionDurationMid,i),{[`
        ${s}${o}-enter,
        ${s}${o}-appear
